...
function criarCsp(nonce: string): string {
  ...
  return [
    ...
    "img-src 'self' data: blob: https://*.google-analytics.com https://*.googlesyndication.com",
    "font-src 'self' data:",
    `connect-src 'self' https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com https://*.g.doubleclick.net https://*.google.com${desenvolvimento ? " ws: wss:" : ""}`,
    "media-src 'none'",
    "object-src 'none'",
    "frame-src 'none'",
    "base-uri 'none'",
